...
client = Cloudant.iam('57f444d5-dfbd-4fc0-b752-dea54005c3ccbluemix')
HTLp9_GkWGDyMR9VHruMMwi_qzZ43qaI3UVR77GOI2GX', connect=True)
...
Team ID
Project Name
toDetect Active Drowning
Maximum Marks 4 Marks
PNT2022TMID52361
Virtual Eye - Life Guard for Swimming Pools
#registration page
@app.route('/register')
def register():
